            ...
            <div className="flex flex-col items-center justify-center w-full text-center bg-gradient-to-t from-background ">
              <AnimationContainer className="flex flex-col items-center justify-center w-full text-center pb-20">
                ...
                <p className="mb-12 text-lg tracking-tight text-muted-foreground md:text-xl text-balance">
                  Effortlessly bridge language barriers with Langpost.
                  <br className="hidden md:block" />
                  <span className="hidden md:block">
                    Translate, analyze, and organize your multilingual content
                    in one place.
                  </span>
                </p>
            ...
            <AnimationContainer delay={0.1}>
              <div className="flex flex-col w-full items-center lg:items-center justify-center py-8">
                ...
                <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
                  Langpost is a cutting-edge AI translator that delivers
                  accurate, context-aware translations tailored to your needs.
                </p>
              </div>
            </AnimationContainer>
          ...
          <MaxWidthWrapper className="py-10">
            <AnimationContainer delay={0.1}>
              <div className="flex flex-col items-center lg:items-center justify-center w-full py-8 max-w-xl mx-auto">
                ...
                <h2 className="text-center lg:text-center text-3xl md:text-5xl !leading-[1.1] font-medium font-heading text-foreground mt-6">
                  Seamless Language Conversion in 3 Steps
                </h2>
                <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
                  Follow these simple steps to translate, transcribe, and
                  publish multilingual content with ease.
                </p>
              </div>
            </AnimationContainer>
