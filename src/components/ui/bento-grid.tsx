...
export const CARDS = [
  {
    ...
    background: (
      <Card className="absolute top-10 left-10 origin-top rounded-none rounded-tl-md transition-all duration-300 ease-out [mask-image:linear-gradient(to_top,transparent_0%,#000_100%)] group-hover:scale-105 border border-border border-r-0">
        <CardHeader>
          <CardTitle>Accurate Translations</CardTitle>
          <CardDescription>
            Deliver flawless translations across over 100 languages with ease.
          </CardDescription>
        </CardHeader>
  ...
  {
    Icon: SearchIcon,
    name: "Convert In any Lnaguage",
    description: "Quickly share your creativity while speaking with Langpost",
    href: "#",
    cta: "Learn more",
  ...
  {
    Icon: CalendarIcon,
    name: "Smart search for your translations",
    description:
      "Keep track of your translation projects with our integrated calendar.",
    className: "col-span-3 lg:col-span-1",
    href: "#",
    cta: "Learn more",
    background: (
